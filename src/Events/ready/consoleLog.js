...
export default async function (argument, client, handler) {
  console.log("-----------------------------------");
  console.log(`${client.user.tag} Online`);
  console.log(`Current Server: ${client.guilds.cache.map((g) => g.id).length}`);
  console.log("-----------------------------------");

  // Set bots status
  client.user.setActivity("Bot", { type: ActivityType.Watching });
